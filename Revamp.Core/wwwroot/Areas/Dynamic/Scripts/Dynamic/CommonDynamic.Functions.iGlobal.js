...
iGlobal.pager.init = function (model) {
    ...
    $(model.divID + '_wrapper .col-sm-6:eq(0) .form-control.input-sm').addClass('iris-pager-ddl');
...
iGlobal.pager.pageState = function (model) {
    ...
    iGlobal.pager.pageTotal = Math.ceil(model.currentJsonData.recordsFiltered / table[model.tableId].ajax.params().length);
    iGlobal.pager.currentPageSelected = (table[model.tableId].ajax.params().start + table[model.tableId].ajax.params().length) / table[model.tableId].ajax.params().length;
...
iGlobal.pager.html = function () {
    ...
    if (iGlobal.pager.btnStatus == '' || iGlobal.pager.btnStatus == undefined || iGlobal.pager.btnStatus == null)
        iGlobal.pager.btnGoto = '<select data-owner="' + iGlobal.pager.id + '" data-cmd="goto" name="' + iGlobal.pager.id + '_pageSelect" aria-controls="' + iGlobal.pager.id + '" class="btn btn-default iris-pager-nav-select iris-pager-nav-btn" title="Current Page" style="border-right:1px!important;display: inline-block !important; height: 34px !important; width: 70px !important; border: 1px solid rgb(229, 229, 229) !important;" ' + iGlobal.pager.disPageSelect + '>' + iGlobal.pager.pageHtml + '</select>';
    else {
    ...
    iGlobal.pager.navHtml =
                '<a type="button" data-owner="' + iGlobal.pager.id + '" data-cmd="snap_left" name="btnScrollSnapLeft" id="' + iGlobal.pager.id + '_btnScrollSnapLeft" class="btn btn-default iris-pager-nav" style="border-left: 0px; border-right: 1px solid #e5e5e5; border-top: 1px solid #e5e5e5; height: 34px !important; border-bottom: 1px solid #e5e5e5;display: inline-block !important" title="Snap Table Left">' +
                    '<i class="mdi mdi-format-horizontal-align-left"></i>' +
                '</a>' +
                '<a type="button" data-owner="' + iGlobal.pager.id + '" data-cmd="first" name="btnPageFirst" id="' + iGlobal.pager.id + '_btnPageFirst" class="btn btn-default iris-pager-nav iris-pager-nav-btn" style="border-left: 1px solid #e5e5e5; border-right: 1px solid #e5e5e5; border-top: 1px solid #e5e5e5; height: 34px !important; border-bottom: 1px solid #e5e5e5;display: inline-block !important" title="First Page" ' + iGlobal.pager.btnFirst + '>' +
                    //'<i class="fa fa-fast-backward"></i>' +
                    '<i class="mdi mdi-page-first"></i>' +
                '</a>' +
                '<a type="button" data-owner="' + iGlobal.pager.id + '" data-cmd="previous" name="btnPagePrev" id="' + iGlobal.pager.id + '_btnPagePrev" class="btn btn-default iris-pager-nav iris-pager-nav-btn" style="border:1px solid #e5e5e5;display: inline-block !important; height: 34px !important;" title="Previous Page" ' + iGlobal.pager.btnPrev + '>' +
                    //'<i class="fa fa-backward"></i>' +
                    '<i class="mdi mdi-chevron-left"></i>' +
                '</a>' +
                '<a type="button" data-owner="' + iGlobal.pager.id + '" data-cmd="next" name="btnPageNext" id="' + iGlobal.pager.id + '_btnPageNext" class="btn btn-default iris-pager-nav iris-pager-nav-btn" style="border:1px solid #e5e5e5;display: inline-block !important; height: 34px !important;" title="Next Page" ' + iGlobal.pager.btnNext + '>' +
                    //'<i class="fa fa-forward"></i>' +
                    '<i class="mdi mdi-chevron-right"></i>' +
                '</a>' +
                '<a type="button" data-owner="' + iGlobal.pager.id + '" data-cmd="last" name="btnPageLast" id="' + iGlobal.pager.id + '_btnPageLast" class="btn btn-default iris-pager-nav iris-pager-nav-btn" style="border-right: 1px solid #e5e5e5; border-left: 1px solid #e5e5e5; border-top: 1px solid #e5e5e5; border-bottom: 1px solid #e5e5e5; display: inline-block !important; height: 34px !important;" title="Last Page" ' + iGlobal.pager.btnLast + '>' +
                    //'<i class="fa fa-fast-forward"></i>' +
                    '<i class="mdi mdi-page-last"></i>' +
                '</a>' +
                '<a type="button" data-owner="' + iGlobal.pager.id + '" data-cmd="snap_right" name="btnScrollSnapRight" id="' + iGlobal.pager.id + '_btnScrollSnapRight" class="btn btn-default iris-pager-nav" style="border-left: 1px solid #e5e5e5; border-right: 1px solid #e5e5e5; border-top: 1px solid #e5e5e5; height: 34px !important; border-bottom: 1px solid #e5e5e5;display: inline-block !important" title="Snap Table Right">' +
