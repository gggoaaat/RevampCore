...
var Layout = function () {
    ...
    var handleSidebarAndContentHeight = function () {
        ...
        if (body.hasClass("page-footer-fixed") === true && body.hasClass("page-sidebar-fixed") === false) {
            ...
            if (body.hasClass('page-full-width') === true && window.location.pathname.indexOf('/form/') > -1) {
                body.attr('style', 'background:#fff !important;');
                content.attr('style', 'min-height:' + height + 'px;background:#fff !important;');
            } else {
    ...
    var handleSidebarMenu = function () {
        jQuery('.page-sidebar').on('click', 'li > a', function (e) {
            ...
            if ($(this).next().hasClass('sub-menu') === false) {
                if (Metronic.getViewPort().width < 992) { // close the menu on mobile view while loading a page 
    ...
    var handleTheme = function () {
        ...
        var setColor = function (color) {
            ...
            $.getJSON("/home/getlogopath", function (data) {
                if (color == 'light2') {
                    $('.page-logo img:not(".applogo")').attr('src', data + '/logo-invert.png');
                } else {
                    $('.page-logo img:not(".applogo")').attr('src', data + '/logo.png');
                }
            });
