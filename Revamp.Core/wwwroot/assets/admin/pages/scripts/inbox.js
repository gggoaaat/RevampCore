var Inbox = function () {
    ...
    var loadCompose = function (el) {
        ...
        $.getJSON("/identity/getidentities/", function (data) {
            ...
            $(".mail-to input:first").autocomplete({ source: data });
            $(".mail-to input:first").tagit({
                availableTags: data
    ...
    var handleCCInput = function () {
        ...
        $.getJSON("/identity/getidentities/", function (data) {
            ...
            $(".inbox-compose .input-cc input").autocomplete({ source: data });
    ...
    var handleBCCInput = function () {
        ...
        $.getJSON("/identity/getidentities/", function (data) {
            ...
            $(".inbox-compose .input-bcc input").autocomplete({ source: data });
