  ...
  //      chart3();
   ...
   //     chart5();
    ...
    var handleUniform = function () {
        ...
        var test = $("input[type=checkbox]:not(.toggle), input[type=radio]:not(.toggle, .star, #pricing)");
        if (test) {
            test.uniform();
        }
    }
    ...
    var handleEditableTables = function () {
        ...
        function editRow(oTable, nRow) {
            var aData = oTable.fnGetData(nRow);
            var jqTds = $('>td', nRow);
            jqTds[0].innerHTML = '<input type="text" class="m-wrap small" value="' + jqTds[0].innerText + '"> ';
        ...
        $('#sample_editable_1 a.edit').live('click', function (e) {
            ...
            if (nEditing !== null && nEditing != nRow) {
                ...
                var sData = $('input', nEditing);
                var gDate = $(this).parents('tr').find('.date_created').html();

                if (!gDate) //Checks to see if the row is new
                {
                    //alert('Test1 :' + gDate);
                    $.post('/apps.aspx?' , 'n=' + sData[0].value + '&i=0' + '&t=0'); //Add new app
                }else
                {
                    //alert('Test2 :' + gDate);
                    $.post('/apps.aspx?' , 'n=' + sData[0].value + '&i=' + sData.parent().attr('id') + '&t=1'); //Update app
                }
...
//          //  oTable.fnUpdate(jqInputs[2].value, nRow, 2, false);
//          //  oTable.fnUpdate(jqInputs[3].value, nRow, 3, false);
//            oTable.fnUpdate('<a class="edit" href="editform.aspx/"?id='+ jqInputs[0].value +'>Edit</a>', nRow, 0, false);
...
//        }
        ...
        $('#forms_new').click(function (e) {
           ...
           /* var aiNew = oTable.fnAddData(['', '', '', '',
            ...
            window.location.href = '/newform.aspx';
        ...
        $('#sample_editable_1 a.delete').live('click', function (e) {
            ...
            if (confirm("Are you sure to delete this form ?") == false) {
                return;
            }
        ...
        $('#sample_editable_1 a.edit').live('click', function (e) {
           ...
           // var gDate = $(this).parents('tr').find('.date_created').html();
                ...
                window.location.href = '/editform.aspx?id='+ sData.parent().attr('id');
...
//                nEditing = null;
    ...
    var handleStartForm = function () {
        ...
        $('#form_start input').keypress(function (e) {
            if (e.which == 13) {
                if ($('#form_start').validate().form()) {
                   $('#form_start').submit();
                }
                return false;
            }
    ...
    var handleFormValidation = function () {
        ...
        //Start Form
       /* var formStart = $('#form_start');
        var errorStart = $('.alert-error', formStart);
        var successStart = $('.alert-success', formStart);
    ...
    return {
        ...
        init: function () {
            ...
            if (App.isPage("all_forms")) {
                handleForms(); // handle all forms page
            }
            ...
            if (App.isPage("form_validation") || App.isPage("Start")) {
        ...
        // start form page setup
        initStart: function () {
            handleStartForm(); // handles login form
            handleUniform(); // // handles uniform elements
            handleFixInputPlaceholderForIE(); // fixes/enables html5 placeholder attribute for IE9, IE8
        },
