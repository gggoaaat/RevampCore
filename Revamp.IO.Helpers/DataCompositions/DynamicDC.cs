...
{
    public class DynamicDC : DataCompositionHelper
    {
        public override int TemplateOrdinal { get { return 100000000; } }
        ...
        public override DynamicModels.ReportDefinitions ReportMapper(IConnectToDB _Connection, DynamicModels.ReportDefinitions thisDefinition)
        {
            ...
            switch (thisDefinition.SearchReport.ToLower())
            {
                default:
                    ...
                    break;
                case "custom reports":
                    CurrentReportSelected = DynamicDC.CustomReports(new DynamicModels.RootReport());
                    break;
                case "custom report order":
                    CurrentReportSelected = DynamicDC.CustomReportOrder(new DynamicModels.RootReport());
                    break;
                case "custom report columns":
                    CurrentReportSelected = DynamicDC.CustomReportColumns(new DynamicModels.RootReport());
                    break;
                case "custom report filters":
                    CurrentReportSelected = DynamicDC.CustomReportFilters(new DynamicModels.RootReport());
                    break;
                case "custom reports utilized":
                    CurrentReportSelected = DynamicDC.CustomReportUtilized(new DynamicModels.RootReport());
                    break;
                case "root reports":
                    CurrentReportSelected = DynamicDC.RootReportsSearch(new DynamicModels.RootReport());
                    break;
                case "root report column order":
                    CurrentReportSelected = DynamicDC.RootReportColumnOrder(new DynamicModels.RootReport());
                    break;
                case "root reports and filters":
                    CurrentReportSelected = DynamicDC.RootReportsAndFilters(new DynamicModels.RootReport());
                    break;
                case "root report columns":
                    CurrentReportSelected = DynamicDC.RootReportColumns(new DynamicModels.RootReport());
                    break;
                case "custom report permissions":
                    CurrentReportSelected = DynamicDC.CustomReportPermissions(new DynamicModels.RootReport());
                    break;
                case "utilized custom report permissions":
                    CurrentReportSelected = DynamicDC.CustomReportUtilizedPermissions(new DynamicModels.RootReport());
                    break;

            }

            Revamp.IO.Helpers.DataCompositions.UniversalHelper.GetTableStructure(_Connection, thisDefinition, CoreOut, CurrentReportSelected);
        ...
        public override List<DynamicModels.RootReport> Reports
        {
            get
            {
                ...
                CoreReports.Add(CustomReportUtilizedPermissions(new DynamicModels.RootReport()));
        ...
        private static DynamicModels.RootReport CustomReports(DynamicModels.RootReport thisCoreReport)
        {
            ...
            thisCoreReport.ReportFilters.Add(new DynamicModels.RootReportFilter { FilterName = "ROOT_REPORT_NAME", PrettyName = "ROOT_REPORT_NAME", DBType = System.Data.SqlDbType.VarChar, ParamSize = 250, SearchDBType = System.Data.SqlDbType.VarChar, SearchParamSize = -1, inPickList = true, FilterType = DynamicModels.FilterType.MultiSelect, FilterSelect = "DISTINCT ROOT_REPORT_NAME" });
        ...
        private static DynamicModels.RootReport CustomReportColumns(DynamicModels.RootReport thisCoreReport)
        {
            #region Report Root Reports and Filters
            thisCoreReport = new DynamicModels.RootReport();
        ...
        private static DynamicModels.RootReport CustomReportOrder(DynamicModels.RootReport thisCoreReport)
        {
            #region Report Root Reports and Filters
            thisCoreReport = new DynamicModels.RootReport();
        ...
        private static DynamicModels.RootReport CustomReportFilters(DynamicModels.RootReport thisCoreReport)
        {
            #region Report Root Reports and Filters
            thisCoreReport = new DynamicModels.RootReport();
        ...
        private static DynamicModels.RootReport CustomReportUtilized(DynamicModels.RootReport thisCoreReport)
        {
            #region Report Root Reports and Filters
            thisCoreReport = new DynamicModels.RootReport();
        ...
        private static DynamicModels.RootReport RootReportsAndFilters(DynamicModels.RootReport thisCoreReport)
        {
            #region Report Root Reports and Filters
            thisCoreReport = new DynamicModels.RootReport();
        ...
        private static DynamicModels.RootReport RootReportsSearch(DynamicModels.RootReport thisCoreReport)
        {
            #region Report Root Reports and Filters
            thisCoreReport = new DynamicModels.RootReport();
            thisCoreReport.ReportName = "Root Reports";
            thisCoreReport.Source = "VIEW_ROOT_REPORTS";
            thisCoreReport.ProcedureName = "SP_S_VIEW_ROOT_REPORTS_SEARCH";
            thisCoreReport.ReportFilters = new List<DynamicModels.RootReportFilter>();
        ...
        private static DynamicModels.RootReport RootReportColumnOrder(DynamicModels.RootReport thisCoreReport)
        {
            #region Report Root Reports and Filters
            thisCoreReport = new DynamicModels.RootReport();
        ...
        private static DynamicModels.RootReport RootReportColumns(DynamicModels.RootReport thisCoreReport)
        {
            #region Report Root Reports and Filters
            thisCoreReport = new DynamicModels.RootReport();
        ...
        private static DynamicModels.RootReport CustomReportPermissions(DynamicModels.RootReport thisCoreReport)
        {
            #region Report Root Reports and Filters
            thisCoreReport = new DynamicModels.RootReport();
            ...
            thisCoreReport.ReportFilters.Add(new DynamicModels.RootReportFilter { FilterName = "IDENTITY_ID", PrettyName = "IDENTITY_ID", DBType = System.Data.SqlDbType.BigInt, SearchDBType = System.Data.SqlDbType.VarChar, SearchParamSize = -1, inPickList = true, FilterType = DynamicModels.FilterType.MultiSelect, FilterSelect = "DISTINCT IDENTITY_ID" });
            thisCoreReport.ReportFilters.Add(new DynamicModels.RootReportFilter { FilterName = "PRIVILEGE_ID", PrettyName = "PRIVILEGE_ID", DBType = System.Data.SqlDbType.BigInt, SearchDBType = System.Data.SqlDbType.VarChar, SearchParamSize = -1, inPickList = true, FilterType = DynamicModels.FilterType.MultiSelect, FilterSelect = "DISTINCT PRIVILEGE_ID" });
        ...
        private static DynamicModels.RootReport CustomReportUtilizedPermissions(DynamicModels.RootReport thisCoreReport)
        {
            #region Report Root Reports and Filters
            thisCoreReport = new DynamicModels.RootReport();
            thisCoreReport.ReportName = "Utilized Custom Report Permissions";
            thisCoreReport.Source = "VIEW_CUSTOM_REPORT_UTILIZED_AND_PERMISSIONS";
            thisCoreReport.ProcedureName = "SP_S_VIEW_CUSTOM_REPORT_UTILIZED_AND_PERMISSIONS_SEARCH";
            thisCoreReport.ReportFilters = new List<DynamicModels.RootReportFilter>();
