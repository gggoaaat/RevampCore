...
namespace Revamp.IO.Structs.Models.DataEntry
{
    public partial class Values
    {
        ...
        {
            public string V_PROCEDURE_NAME { get; set; } = "SP_I_" + "ROLES";
            public string V_ATTEMPTED_SQL { get; set; }
            public string I_THIS_CALLER { get; set; } = "";
            public long? I_BASE_ROLES_ID { get; set; } = 0;
            public long? I_PREV_ROLES_ID { get; set; } = 0;
            public Guid? I_BASE_ROLES_UUID { get; set; }
            public Guid? I_PREV_ROLES_UUID { get; set; }
            ...
            public string I_OBJECT_TYPE { get; set; } = "Role";
            ...
            public long? O_ROLES_ID { get; set; }
            public Guid? O_ROLES_UUID { get; set; }
        }
    }
}
