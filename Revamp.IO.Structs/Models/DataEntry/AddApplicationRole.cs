...
namespace Revamp.IO.Structs.Models.DataEntry
{
    public partial class Values
    {
        ...
        public class AddApplicationRole
        {
            ...
            public string V_PROCEDURE_NAME { get; set; } = "SP_I_APPLICATIONS_SEC_ROLE";
            public long? I_BASE_APPLICATIONS_SEC_ROLE_ID { get; set; } = 0;
            public long? I_PREV_APPLICATIONS_SEC_ROLE_ID { get; set; } = 0;
            public Guid? I_BASE_APPLICATIONS_SEC_ROLE_UUID { get; set; }
            public Guid? I_PREV_APPLICATIONS_SEC_ROLE_UUID { get; set; }
            ...
            public long? O_APPLICATIONS_SEC_ROLE_ID { get; set; }
            public Guid? O_APPLICATIONS_SEC_ROLE_UUID { get; set; }
        }
    }
}
...
namespace Revamp.IO.Structs.Models
{
    public partial class CASTGOOP
    {
        ...
        public class AddApplicationRole
        {
            public string V_ATTEMPTED_SQL { get; set; }
            public string V_PROCEDURE_NAME { get; set; } = "SP_I_APPLICATIONS_SEC_ROLE";
            public object I_BASE_APPLICATIONS_SEC_ROLE_ID { get; set; } = 0;
            public object I_PREV_APPLICATIONS_SEC_ROLE_ID { get; set; } = 0;
            public object I_BASE_APPLICATIONS_SEC_ROLE_UUID { get; set; }
            public object I_PREV_APPLICATIONS_SEC_ROLE_UUID { get; set; }
            ...
            public object O_APPLICATIONS_SEC_ROLE_ID { get; set; }
            public object O_APPLICATIONS_SEC_ROLE_UUID { get; set; }
        }
    }
}