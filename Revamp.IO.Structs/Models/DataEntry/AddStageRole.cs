...
namespace Revamp.IO.Structs.Models.DataEntry
{
    ...
    {
        [Serializable]
        public class AddStageRole
        {
            public string V_ATTEMPTED_SQL { get; set; }
            public string V_PROCEDURE_NAME { get; set; } = "SP_I_STAGES_SEC_ROLE";
            public long? I_BASE_STAGES_SEC_ROLE_ID { get; set; } = 0;
            public long? I_PREV_STAGES_SEC_ROLE_ID { get; set; } = 0;
            public Guid? I_BASE_STAGES_SEC_ROLE_UUID { get; set; }
            public Guid? I_PREV_STAGES_SEC_ROLE_UUID { get; set; }
            ...
            public long? O_STAGES_SEC_ROLE_ID { get; set; }
            public Guid? O_STAGES_SEC_ROLE_UUID { get; set; }
        }
    }
}
...
namespace Revamp.IO.Structs.Models
{
    public partial class CASTGOOP
    {
        ...
        public class AddStageRole
        {
            public string V_ATTEMPTED_SQL { get; set; }
            public string V_PROCEDURE_NAME { get; set; } = "SP_I_STAGES_SEC_ROLE";
            public object I_BASE_STAGES_SEC_ROLE_ID { get; set; } = 0;
            public object I_PREV_STAGES_SEC_ROLE_ID { get; set; } = 0;
            public object I_BASE_STAGES_SEC_ROLE_UUID { get; set; }
            public object I_PREV_STAGES_SEC_ROLE_UUID { get; set; }
            ...
            public object O_STAGES_SEC_ROLE_ID { get; set; }
            public object O_STAGES_SEC_ROLE_UUID { get; set; }
        }
    }
}