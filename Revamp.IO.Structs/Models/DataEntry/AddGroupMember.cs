...
namespace Revamp.IO.Structs.Models.DataEntry
{
    public partial class Values
    {
        ...
        public class AddGroupMember
        {
            ...
            public string V_PROCEDURE_NAME { get; set; } = "SP_I_GROUP_MEMBERS";
            public long? I_BASE_GROUP_MEMBERS_ID { get; set; } = 0;
            public long? I_PREV_GROUP_MEMBERS_ID { get; set; } = 0;
            public Guid? I_BASE_GROUP_MEMBERS_UUID { get; set; }
            public Guid? I_PREV_GROUP_MEMBERS_UUID { get; set; }
            ...
            public long? I_GROUPS_ID { get; set; }
            public long? O_ERR_NUMB { get; set; }
            public string O_ERR_MESS { get; set; }
            public long? O_GROUP_MEMBERS_ID { get; set; }
            public Guid? O_GROUP_MEMBERS_UUID { get; set; }
        }
    }
}
