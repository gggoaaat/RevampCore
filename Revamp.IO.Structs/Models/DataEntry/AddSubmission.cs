...
namespace Revamp.IO.Structs.Models.DataEntry
{
    public partial class Values
    {
        ...
        public class AddSubmission
        {
            ...
            public string V_PROCEDURE_NAME { get; set; } = "SP_I_SUBMISSIONS";
            public long? I_BASE_SUBMISSIONS_ID { get; set; } = 0;
            public long? I_PREV_SUBMISSIONS_ID { get; set; } = 0;
            public Guid? I_BASE_SUBMISSIONS_UUID { get; set; }
            public Guid? I_PREV_SUBMISSIONS_UUID { get; set; }
            ...
            public long? O_SUBMISSIONS_ID { get; set; }
            public Guid? O_SUBMISSIONS_UUID { get; set; }
        }
    }
}
...
namespace Revamp.IO.Structs.Models
{
    public partial class CASTGOOP
    {
        ...
        public class Submission
        {
            public string V_ATTEMPTED_SQL { get; set; }
            public string V_PROCEDURE_NAME { get; set; } = "SP_I_SUBMISSIONS";
            public object I_BASE_SUBMISSIONS_ID { get; set; } = 0;
            public object I_PREV_SUBMISSIONS_ID { get; set; } = 0;
            public object I_BASE_SUBMISSIONS_UUID { get; set; }
            public object I_PREV_SUBMISSIONS_UUID { get; set; }
            ...
            public object O_SUBMISSIONS_ID { get; set; }
            public object O_SUBMISSIONS_UUID { get; set; }
        }
    }
}